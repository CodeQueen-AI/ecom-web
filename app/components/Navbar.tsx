  ...
  return (
    <nav className="w-full flex items-center justify-between px-10 py-6 relative">
      ...
      <div className="flex items-center gap-8 text-black font-medium poppins">
        ...
        <a className="relative mr-10 after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full cursor-pointer">
          CONTACT
        </a>
